**Technical companion: formal results on incompleteness and task adequacy**

This companion preserves the version 2.0 development of 18 September 2026. Its nine numbered theorems are supporting material for [the main investigation into language, mathematical practice, and relevance](incompleteness_and_metasystems.md). References below to the central aim or strongest conclusion describe the earlier exposition; they do not replace the main investigation's revised question.
